    ...
    <section>
        <div class="sidebar">
            <center>
                ...
                <h4 class="user-name">Admin Admin</h4>
            </center>
            <hr style="background-color:chartreuse;">
            <a href="dashboard.php"> <i class="fas fa-home"></i><span> Dashboard</span></a>
            <a href="admin.php"> <i class="fas fa-user "></i><span>Admin</span></a>
            <a href="technician.php"> <i class="fas fa-th "></i><span>Technician</span></a>
            <a href="repair.php"> <i class="fas fa-info-circle "></i><span>Repair</span></a>
